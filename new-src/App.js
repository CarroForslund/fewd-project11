    ...
    return (
      ...
      <BrowserRouter>
        ...
        <div className="container">
          ...
          <SearchForm onSearch={<FetchPhotos />} />
          <Navigation />
          ...
          <Switch>
            ...
            {
              /*
              <Route path={`${match.path}`} render={ () => <FetchPhotos tag="Cats"/> } />
              <Route path={`${match.path}`} render={ () => <FetchPhotos tag="Coffee"/> } />
              <Route path={`${match.url}`} render={ () => <FetchPhotos tag="Computers"/> } />
              */
            }
          </Switch>
